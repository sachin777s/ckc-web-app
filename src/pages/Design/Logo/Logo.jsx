   ...
   <div className="container">
    <div className="row">
      <div className="col-md-6 mt-5">
        ...
        <p className='fs-5 mt-4'>Designing encapsulating, unique and distinguishing logos that are remembered.</p>
        <ColorButton className="fs-4 mt-5 mb-5 rounded-pill ">Explore logo design</ColorButton>
        <br/>
