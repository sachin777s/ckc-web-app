  ...
  return (
    <section className='mt-12 mb-12 flex gap-8 md:gap-0 items-center justify-center flex-col-reverse md:flex-row scale-75 md:scale-100'>
      <div className="md:w-2/5 w-full">
        <h1 className='text-4xl font-bold'>Exceptional Website Design & Development</h1>
        <h3 className='mt-4 text-base font-bold'>Web Developement Agency</h3>
        ...
        <Link  className="mt-4 block" to={"/website"}>
          <ColorButton >Check Our Website Portfolio</ColorButton>
        </Link>
      </div>
