                ...
                <div className='mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-24 lg:gap-32 xl:gap-40'>
                    {
                        seoTopics.map((singleTopic, i) =>
                            <div
                                key={i}
                                className='w-full md:w-auto py-8 px-2 bg-[var(--secondary-color)] flex flex-col items-center md:px-4 rounded-xl shadow-[0_0_9px_-2px_var(--main-color)]   transition-all duration-500 hover:scale-125 hover:shadow-[0_0_13px_-3px_black]'
                            >
                                <img
                                    className='w-24'
