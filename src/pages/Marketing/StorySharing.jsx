  ...
  return (
    ...
    <div className="row">
      <div className="col-md-6 mt-5">
        ...
        <p className='mt-4 fs-4 mx-5'>We enhance public relations strategies through a comprehensive approach to marketing and PR. By leveraging media coverage and social networks, we generate meaningful leads and help businesses connect with new target audiences, driving growth and expanding reach.</p>
