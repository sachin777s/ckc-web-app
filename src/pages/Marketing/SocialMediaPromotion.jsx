  ...
  return (
    ...
    <div className="row">
      ...
      <div className="col-md-6">
        ...
        <h1 className='fs-1 ms-5 mt-3'>Tailored Social Media Marketing.</h1>
        <p className='mt-4 fs-4 mx-5'>The Noida Marketing Company is here to help you establish your online presence with a social media profile that will enlighten and engage. Our marketing experts have helped companies across the board from all industries generate leads through our effective branding-recognition strategies! The Noida Marketing Company is here to help you establish your online presence with a social media profile that will resonate across all channels.</p>
