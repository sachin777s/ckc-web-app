        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <h1 className='fs-3 ms-5 fw-bold'>Web Development</h1>
              <div className="ms-5 mt-3">
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> Websites Development</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> Web Application Development</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> E-Commerce Solutions</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> SEO Optimization</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> API Integration</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> Performance Optimization</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> Cloud Integration</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> UI/UX Audits</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> Custom Plugin Development</p>
                <p className='fs-4'> <i class="bi bi-check-square-fill me-2 text-danger"></i> API Development & Integration</p>
              </div>
            </div>
            <div className="col-md-4">
